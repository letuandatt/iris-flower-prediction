...
model_paths = {
    'KNN': 'giaodien/models/KNN_iris.joblib',
    'NaiveBayes': 'giaodien/models/NaiveBayes_iris.joblib',
    'DecisionTree': 'giaodien/models/DecisionTree_iris.joblib',
    'RandomForest': 'giaodien/models/RandomForest_iris.joblib',
    'SVM': 'giaodien/models/SVM_iris.joblib',
    'MLP': 'giaodien/models/MLP_iris.joblib',
}

# Load file chuẩn hóa
scaler_path = 'giaodien/models/scaler.joblib'
